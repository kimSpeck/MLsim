...
#     how to count main effects in ENETw? 
#       -> two versions: ...
...
# colValuesLin <- c("lightgrey", "darkgrey", "black")
# colValuesInter <- c("black", "darkgrey", "lightgrey")
...
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/betweenANOVA_pviMainTP.png"),
#                 plot = pEta2_linTP,
#                 width = 17.52,
#                 height = 10.76,
#                 units = "in")
...
(pSensitivityENETw_R2facette_rel08 <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
...
(pSensitivityGBM_R2facette_rel08 <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
                                             plotDiags$model == "GBM" &
                                             plotDiags$rel == 0.8,],
                                 aes(x = N, y = M, 
                                     group = interaction(lin_inter, pTrash), colour = lin_inter,
...
(pSensitivityRel1 <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
                   plotDiags$rel == 1,],
       aes(x = N, y = M, 
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSensitivity_pviRel1.png"),
#                 plot = pSensitivity,
#                 width = 13.08,
#                 height = 12.18,
#                 units = "in")

# sufficient subset of conditions to display take away messages
(pSensitivityRel1pTrash50 <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
                                        plotDiags$rel == 1 &
                                        plotDiags$pTrash == 50,],
                            aes(x = N, y = M, 
                                group = interaction(R2, model), colour = R2,
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSensitivity_pviRel1pTrash50.png"),
#                 plot = pSensitivityRel1pTrash50,
#                 width = 13.08,
#                 height = 7.18,
#                 units = "in")
...
(pSensitivityENETw <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
                                        plotDiags$model == "ENETw",],
                            aes(x = N, y = M, 
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSensitivity_pviENETw.png"),
#                 plot = pSensitivityENETw,
#                 width = 13.08,
#                 height = 12.18,
#                 units = "in")

(pSensitivityENETw_rel08 <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
                                         plotDiags$model == "ENETw" &
                                           plotDiags$rel == 0.8,],
                             aes(x = N, y = M, 
                                 group = interaction(R2, pTrash), colour = R2,
                                 linetype = pTrash, shape = pTrash)) +
    geom_point(position = position_dodge(width = 0.5), size = 2) +
    geom_line(position = position_dodge(width = 0.5), alpha = 0.6) +
    ...
    geom_errorbar(aes(ymin = q025, ymax = q975), 
                  width = 0.2, alpha = 0.4, position = position_dodge(width = 0.5)) +  
    scale_color_manual(values = colValues) +
    facet_wrap(~ lin_inter, labeller = label_both) +
    ylab("sensitivity") +
    xlab("N") +
    ggtitle("sensitivity: TP / (TP + FN)") +
    theme(panel.grid.major = element_line(linewidth = 0.5, linetype = 'solid', color = "grey"), 
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSensitivity_pviENETw_rel08.png"),
#                 plot = pSensitivityENETw_rel08,
#                 width = 13.08,
#                 height = 6.68,
#                 units = "in")

(pSensitivityGBM <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
                                         plotDiags$model == "GBM",],
                             aes(x = N, y = M, 
                                 group = interaction(R2, rel), colour = R2,
                                 linetype = rel, shape = rel)) +
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSensitivity_pviGBM.png"),
#                 plot = pSensitivityGBM,
#                 width = 13.08,
#                 height = 12.18,
#                 units = "in")


(pSensitivityGBM_rel08 <- ggplot(plotDiags[plotDiags$DV == "sensitivity" &
                                       plotDiags$model == "GBM" &
                                       plotDiags$rel == 0.8,],
                           aes(x = N, y = M, 
                               group = interaction(R2, pTrash), colour = R2,
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSensitivity_pviGBM_rel08.png"),
#                 plot = pSensitivityGBM_rel08,
#                 width = 13.08,
#                 height = 6.68,
#                 units = "in")
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSpecificity_pviRel1.png"),
#                 plot = pSpecificityRel1,
#                 width = 13.08,
#                 height = 12.18,
#                 units = "in")
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSpecificity_pviRel1pTrash50.png"),
#                 plot = pSpecificityRel1pTrash50,
#                 width = 13.08,
#                 height = 7.18,
#                 units = "in")
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSpecificity_pviENETw.png"),
#                 plot = pSpecificityENETw,
#                 width = 13.08,
#                 height = 12.18,
#                 units = "in")
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSpecificity_pviENETw_rel08.png"),
#                 plot = pSpecificityENETw_rel08,
#                 width = 13.08,
#                 height = 6.68,
#                 units = "in")
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSpecificity_pviGBM.png"),
#                 plot = pSpecificityGBM,
#                 width = 13.08,
#                 height = 12.18,
#                 units = "in")
...
# # save plot as files
# ggplot2::ggsave(filename = paste0(plotFolder, "/detectMains/mainSpecificity_pviGBM_rel08.png"),
#                 plot = pSpecificityGBM_rel08,
#                 width = 13.08,
#                 height = 6.68,
#                 units = "in")
################################################################################
